...
--
INSERT INTO `tbl_admin` (`aid`, `admin_username`, `admin_password`, `time_stamp`) 
VALUES
...
--
ALTER TABLE `tbl_users`
MODIFY `id` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;/*!40101 SET CHARACTER_SET_CLIENT=@OLD_CHARACTER_SET_CLIENT */;
